...
public class HomeworkM5Driver {
	...
	public static boolean isDoublyLinkedPalindromeList(DoubleNode<Integer> firstNode, DoubleNode<Integer> lastNode) {
		...
		DoubleNode<Integer> currentFirst = firstNode;
		DoubleNode<Integer> currentLast = lastNode;

		while(currentFirst.data==currentLast.data) {
			if(currentFirst.next==currentLast.previous||currentFirst.next==currentLast){
				return true;
			}
